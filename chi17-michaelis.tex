...
\doi{http://dx.doi.org/10.1145/3025453.3025499}
...
\numberofauthors{1}
\author{%
\alignauthor{Joseph E Michaelis,$^{1,2}$ Bilge Mutlu$^1$\\
...
This multi-method approach provides theoretically grounded empirical support for the Four-Phase Model of Interest Development that has been called for in the literature \cite{Renninger:2011}.  Table~\ref{tab:table1} summarizes these findings. We now begin describing themes that emerged from observations of the children interacting with the robot and their post-interviews.
...
This attribution of human characteristics to the robot is consistent with prior work in the field \cite{Duffy:2003}, and we intentionally integrated social behavior in order to further our goals of improving engagement in reading with the robot. We were, however, surprised to find that the social interaction tapped into a strong desire for social companionship while reading.
...
% DONE: I added the four RAs from my lab.
