...
\begin{figure}[t]
	...
	\caption{A study participant reads James and the Giant Peach to Minnie, our learning companion robot.}~\label{fig:figure1}\vspace{-16pt}
\end{figure}
...
% DONE: I included an additional sentence at the end to address this comment.  Does that work, or would you prefer using "i.e."?
...
% TODO: One of the questions the readers are going to have is where these guidelines come specifically. I am guessing that you will bring them in later, but we need to give them an idea of what to expect.
