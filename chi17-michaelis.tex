...
//Add section about posiive effects of oral reading: building confidence, interest, and achievement, create-Rasinski 2008

Before large scale testing of such a system, it is important to gain a better understanding of how a learning companion robot may be used in a child's home, and how these design features will be perceived by the child and their family. In this way, we can further refine the system to reflect actual practices and perceptions of young readers and their families.

\section{METHOD}
 For this study, we first developed a learning companion robot, Minnie, based on our six design guidelines. We then conducted short in-home visits with families to explore their current reading habits and how the learning companion might be used and perceived. During the in-home visits we interviewed families using a semi-structured interview protocol, before and after one child in the home interacted with the learning companion.  We designed our visits to use the learning companion robot as a technology probe \cite{Hutchinson:2003} for discussion and reflection with families in a manner inspired by Odom et. al \cite{Odom:2012}.  Hutchinson et. al \cite{Hutchinson:2003} describes the technology probe approach as a method with three goals: field-testing a technology, understanding the user's needs and feelings about the technology, and reflection on new possibilites for the technology.  We chose to design the study as a technology probe because we believe that at this stage of development our prior understanding of the intended user may not be sufficient.  The introduction of the learning companion into the home may inspire new thoughts and possibilities on it's use, and we intend to explore these and make modifications prior to empirical testing of the design.  In this way, we did not limit the discussion to our preconceived ideas about how, when and where the learning companion should and would be used. Rather, we allowed families to explore ideas about how they would like to use a learning companion robot for reading, even if this included additional features or capabilities not currently available. The following describes this method in more detail.
