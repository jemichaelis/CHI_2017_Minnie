...
\item[$DE4$] Providing a social partner that demonstrates interest in the reading activity;
...
While generating positive affect for a task or area of study is important, reseachers also note that supporting students to find value for a domain (e.g. reading) and improving knowledge and ability in the task are also critical to interest development. As we looked for emerging themes from our data, positive affect, value, and knowledge building were often referenced by families. We found that interacting with Minnie was generally well liked by all of the families that we visited across all phases of interest. This positive experience was attributed to all of the design elements of the learning companion robot. Our phase 2 and phase 3 children also often expressed finding value in the interaction, and much of this was related to the value they felt from increased motivation to read (phase 2), and supporting the development of their reading ability (phase 3). Phase 4 children did not often discuss the value of the interaction to them, and this may be because they value being able develop reading abilities at a higher level than our learning companion robot was able to support. 

We feel that our eight design elements are a good starting point for designing a learning companion robot, or other technology, in reading. As the lack of addressing the reading ability development needs of phase 2 and phase 4 learners appears to be the root cause of not fully supporting their interest development. Therefore, to improve future revisions of our robot, and to inform the design of other learning technologies that intend to support interest and engagement in reading, we suggest providing a wider variety and deliberate support for improving reading. Suggestions from our families include adding chapter summaries, comprehension questions, and direct vocabulary support for our phase 2 readers; and the option to read silently with Minnie and to connect and enrich the reading experience to outside of the book for phase 4 readers. Future work should test how adding this additional knowledge support impacts the child's experience. Other work might also test whether this type of learning companion robot is effective in other domains such as math or science. 

\subsection{Designing for Social Companionship}
While some previous work has been done to study the benefits of social robotics in an educational setting, to the best of our knowledge this is the first evidence that a robot might play a role as a social companion in this setting. We were suprised to find how many of our children simply enjoyed the presence of Minnie as someone else there to read with. To most of the children this was very motivating, and for our lowest phase of interest readers, they found that it made reading less boring. Children also attributed increased focus and attention to their reading, improved reading comprehension, and a desire to include Minnie in other parts of the education and home lives to this feeling of social companionship. We believe the ease of which the children in our study felt a social companionship with Minnie was due in part to the strong attribution of human characteristics to the robot. Our families described Minnie as fun, pleasant and nice, and could picture including the robot in family reading time. They felt she could see and undestand them, and knew what they were reading about. This finding suggests that when designing a social robot as a learning companion, it may be beneficial to more deliberately leverage the benefit of the social companionship that can result. However, further study is needed to better understand this phenomena, and the influence it has on a child's engagement in an educational task.

  
\subsection{Limitations}
While we present findings that help to better understand the use of a learning companion robot for reading, there are several limiations to the study. First, the generalizbility of our findings is limited due to the small size of the sample and the limited geographical region from which it was drawn. We are further limited by not having any children at the lowest phase of interest represented in our study, as we are unable to draw conclusions and comparisions across the entire specture of interest development. We also only conducted our study with children ages 11 and 12, and our results may differ for different age groups. We also recognize that having only interacted with the robot for a short period of time, and only allowing one child to directly interact with Minnie may have influenced how our users reports their experience. Therefore, we recommend that future studies increase the breadth (i.e. a larger sample, from a larger area, made of a broader range of ages and interest phases) or depth (i.e. longer period of interaction with the robot including more family members) of this investigation. Finally, we are also limited in that the robot was only studied in one educational domain, in one medium (a robot) and in the homes of our families. Theory and practice would benefit from observing the experience of using this type of learning companion in other areas of study, using other educational agents, and in other education settings (e.g. classrooms or informal learning environments).

\section{CONCLUSION}
Educational robotics is rapidly expanding area of study, and has the capability of providing powerful and personalized supports to learners from a wide variety of backgrounds, ages, abilities and interests. To further explore these possibilities, we designed Minnie, our learning companion robot, as a technology probe to examine the reading habits of children and how this type of technology might be used by families in their homes. We asked children to interact with Minnie during an in-home visit, and had families participate in pre- and post-interaction interviews in order to dig deeply into these ideas, to help evalute our initial design, and to inspire ideas for future design. Four major themes emerged from our Grounded Theory analysis: 1) the reading habits of our participants aligns with specific phases of the Four-phase Model of Interest Development; 2) interactionn with the robot provided support for the developed of interest in reading; 3) several human characteristics were attributed to the robot, including emotions and thought; and 4) the robot was embraced as a social companion during the act of reading.

Based on our findings we recommend the use of the eight design elements described in this study for similar learning technologies. We also recommend that future designs include additional supports for improving reading ability that better address the needs of childer with a wider range of phases of interest and ability. Finally, we believe our finding that the learning companion robot was seen and appreciated as a social companion needs further investigation, and may prove to be an import mechanism for developing interest in reading. This study provides practical design recommendations for the creation of educational robotics, and may be beneficial to those in other educational technology fields. We also contribute the notion of a robot acting as a social companion to children engaged in an educational task in their home, which has implications for both interest development, and social robotic literatures.  We hope that this work inspires future exploration of the social role that technology plays in interest development in a wide variety of areas.
