...
With drastic improvements in technology in the last decade, the viability of using robots as educational agents, in both classrooms and in the home, has increased dramatically. 

Han, Jo, Park \& Kim \cite{Han:2005} were among the first to report on testing a educational robot for children in their homes.  They found that a home robot promoted concentration, interest, learning, and was also considered friendlier than other learning media.
